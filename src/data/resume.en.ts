...
export const RESUME_EN: ResumeData = {
  ...
  avatar: "/me.JPG",
  intro:
    "A 2025 Software Engineering graduate from NTNU — grade-A thesis, Eureka Prize — now pursuing a Master's in Artificial Intelligence and co-founding Safe Media AI.",
  about:
  ...
  stats: [
    { value: "A", label: "Bachelor thesis" },
    { value: "Eureka", label: "NTNU prize" },
  ...
  research: [
    ...
    },
    {
      ...
      dates: "2025 — Now",
      description:
        "Multi-label movie-genre prediction from plot text + posters (MM-IMDb). LSTM+Attention, DistilBERT, ResNet, and fusion strategies — 59.8% F1-macro with Attention Fusion.",
  ...
  personal: [
    ...
    },
    {
      ...
      image: "/strack-og.png",
      description:
        "A SaaS that tames recurring expenses. Paste a link or type a service — AI parses pricing and billing from 100+ services. Multi-currency, analytics, renewal alerts.",
    ...
    },
    {
      ...
      image: "/1.2.watch.png",
      description:
        "“When to Watch” — track movies, series and anime in one place. Know when the next episode airs and where to stream it, with smart recommendations.",
