...
"• learned how to asses levels of understanding and provide ideal guidance",
  ...
  masterProjects: [
    {
      title: "Graph Tsetlin Machine for Hex Board Game Winner Prediction",
      href: "https://github.com/yasinhessnawi1/tsetlin-hex",
      dates: "Aug 2025 - Present",
      active: true,
      description: "A modular, high-performance implementation of Graph Tsetlin Machines (GTM) applied to the Hex board game for winner prediction using deep logical learning and reasoning. The project uses interpretable AI methods that learn logical rules through clause-based learning and message passing across graph structures. Achieves 99-100% prediction accuracy on 10x10 boards at end-game stages, with CUDA-accelerated training for efficient GPU utilization.",
      technologies: [
        "Python",
        "CUDA",
    ...
    {
      title: "Multimodal Genre Classification - MM-IMDb",
      href: "https://github.com/yasinhessnawi1/ml-project",
      dates: "Aug 2025 - Present",
      active: true,
      description: "Deep learning project for multi-label movie genre prediction from text (plot summaries) and images (movie posters) using the MM-IMDb dataset. Implemented multiple architectures including LSTM with Attention, DistilBERT, ResNet-18/50, and various fusion strategies (Early, Late, Attention-Based). Achieved 59.79% F1-Macro with Attention Fusion model, demonstrating the effectiveness of multimodal learning over unimodal approaches.",
      technologies: [
        "Python",
        "PyTorch",
        "Deep Learning",
